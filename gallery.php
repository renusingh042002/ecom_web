                    ...
                    <div class="row flex-row-reverse">
                        ...
                        <div class="col-lg-9 col-md-12 col-12">
                            ...
                            <div class="collection-product-container">
                                <div class="row">
                                 <?php
                                 $show ="select * from product_table where label='gallery'";
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card-details">
                                                ...
                                                <h3 class="product-card-title">
                                                    <a href="collection-left-sidebar.html"><?php echo $row["product_name"]?></a>
                                                </h3>
                                                <div class="product-card-price">
                                                    <span class="card-price-regular"><i class="fa-solid fa-indian-rupee-sign"></i><?php echo $row["price"]?></span>
                                                    <span
                                                        class="card-price-compare text-decoration-line-through"><i class="fa-solid fa-indian-rupee-sign"></i>1759</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="collection-filter filter-drawer">
                                ...
                                <div class="filter-widget">
                                    ...
                                    <div id="filter-collection" class="accordion-collapse collapse show">
                                        <form action="gallery_filter_product.php" method = "post">
                                        <ul class="filter-lists list-unstyled mb-0">
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    <input type="checkbox" value="mymen" name="men" />
                                                    <span class="filter-checkbox rounded me-2"></span>
                                                    <span class="filter-text"> Men Shoes</span>
                                                </label>
                                            </li>
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    <input type="checkbox" value="mywomen"  name="women" />
                                                    <span class="filter-checkbox rounded me-2"></span>
                                                    Women Hell
                                                </label>
                                            </li>
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    <input type="checkbox" value="myformal" name="formal" />
                                                    <span class="filter-checkbox rounded me-2"></span>
                                                    Formal Shoes
                                                </label>
                                            </li>
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    ...
                                                    <button type="submit" class="btn btn-primary"  name="applyproduct">Check</button>
                                                </label>
                                            </li>
...
<!-- filter by price -->
                                ...
                                <div class="filter-widget">
                                    ...
                                    <div id="filter-price" class="accordion-collapse collapse show" style="padding-top:20px;">
                                       <form action="gallery_assen_and_dassen.php" method = "post">
                                       ass<input type ="radio" value="ascending" name="order" >
                                        dese<input type ="radio" value="dascending" name="order">
                                        <button type="submit" class="btn btn-primary" name="applyfilter">Check</button>
                                       
                                        </form>
                                        <!-- <div class="filter-price d-flex align-items-center justify-content-between">
                                            <form  method="post">
                                            <div class="filter-field">
                                                <input class="field-input" type="number" placeholder="$0" value="asscending" name="p">
                                            </div>
                                            <div class="filter-separator px-3">To</div>
                                            <div class="filter-field">
                                                <input class="field-input" type="number" min="0" placeholder="$0" value="disaccending" name="p">
                                            </div>
                                            <div class="filter-separator px-1"></div>
                                            <div class="filter-field">
                                                <a href="gallery_assen_and_dassen.php"><input class="field-input" type="submit" value="check" name="save" ></a>
                                            </div>
                                        </form>
                                        </div> -->
...
<!-- filter by price -->
                                        ...
                                        <ul class="filter-lists list-unstyled mb-0">
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    <input type="checkbox" />
                                                    <span class="filter-checkbox rounded me-2"></span>
                                                    <span class="filter-text">Shoes</span>
                                                </label>
                                            </li>
                                            <li class="filter-item">
                                                <label class="filter-label">
                                    ...
                                    <div class="filter-related">
                                        <div class="related-item d-flex">
                                            <div class="related-img-wrapper">
                                                <img class="related-img" src="assets/img/products/shoe/1.jpg"
                                                    alt="img">
                                            </div>
                                            <div class="related-product-info">
                                                ...
                                                <div
                                                    ...
                                                    <img src="assets/img/products/shoe/1.jpg" alt="img">
                                                    <img src="assets/img/products/shoe/2.jpg" alt="img">
                                                    <img src="assets/img/products/shoe/3.jpg" alt="img">
                                                    <img src="assets/img/products/shoe/4.jpg" alt="img">
                                                    <img src="assets/img/products/shoe/5.jpg" alt="img">
                                                </div>
                                        ...
                                        <div class="related-item d-flex">
                                            <div class="related-img-wrapper">
                                                <img class="related-img" src="assets/img/products/shoe/7.jpg"
                                                    alt="img">
                                            </div>
                                            <div class="related-product-info">
                                                <h2 class="related-heading heading_18">
                                        ...
                                        <div class="related-item d-flex">
                                            <div class="related-img-wrapper">
                                                <img class="related-img" src="assets/img/products/shoe/8.jpg"
                                                    alt="img">
                                            </div>
                                            <div class="related-product-info">
                                                <h2 class="related-heading heading_18">
                                ...
                                <!-- <div class="filter-widget">
                                    <a href="product.html">
                                        <img class="rounded" src="assets/img/products/shoe/10.jpg" alt="img">
                                    </a>
                                </div> -->
                            </div>
                        </div>
