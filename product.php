...
<body>
    <div class="body-wrapper">
       ...
       <!-- yanha se product ki cooding karni he -->
        ...
        <?php
          $product="select * from product_table where id=?";
          $qry=$conn->prepare($product);
          $qry->bind_param("i",$_GET['pid']);
          $qry->execute();
                    ...
                    <div class="row">
                                ...
                                <div class="product-img-large">
                                    <div class="img-large-slider common-slider" data-slick='{
                                        ...
                                        <div class="img-large-wrapper">
                                            <a href="assets/img/products/shoe/<?php echo $i;?>.jpg?pid=<?php echo $row['id']  ?>" data-fancybox="gallery">
                                                <!-- product image ka pura path dena he ishke baad image name jo ki databse se la rhe he -->
                                                <img src="ADMIN/images/<?php echo $i;?>" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-details ps-lg-4">
                                ...
                                <!-- product name hm databse se la rhe he -->
                                ...
                                <div class="product-price-wrapper mb-4">
                                    <!-- price hm database se la rhe he -->
                                    <span class="product-price regular-price"><?php echo $row['price'] ?></span>
                                ...
                                <div class="product-vendor product-meta mb-3">
                                    <!-- vender hm databse se la rhe he -->
                                    <strong class="label">Vendor:</strong> <?php echo $row['vender'] ?>
                                </div>
                                    ...
                                    <div class="product-variant product-variant-other">
                                        ...
                                        <ul class="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                            <li class="variant-item">
                                                ...
                                                <!-- size hm database se la rhe he -->
                                                <label class="variant-label"><?php echo $row['size'] ?></label>
                                            </li>
                                ...
                                <form action="cart.php" method="post">                   
                                    <div class="buy-it-now-btn mt-2">
                                       <button type="submit" class="position-relative btn-atc btn-buyit-now" name="bye">BUY IT NOW</button>
                                    </div>
                                </form>
                        ...
                        <div id="pdescription" class="tab-pane fade show active">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="desc-img">
                                        <!-- desciption image -->
                                        <img src="assets/img/products/shoe/9.jpg" alt="img">
                                    </div>
                                </div>
                            ...
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="assets/img/products/shoe/9.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="assets/img/products/shoe/9.jpg"
                                        alt="product-img">
                                </a>
