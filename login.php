    ...
    <div class="announcement-bar bg-1 py-1 py-lg-2">
        ...
        <main id="MainContent" class="content-for-layout">
            <div class="login-page mt-100">
                <div class="container">
                    <form action="loginprocess.php" method="post" class="login-form common-form mx-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <button type="submit" class="btn-primary d-block mt-4 btn-signin" name="mysave">SIGN IN</button>
