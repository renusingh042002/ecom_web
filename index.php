            ...
            <div class="featured-collection mt-100 overflow-hidden">
                <div class="collection-tab-inner">
                    <div class="container">
                        ...
                        <div class="row">
                        <?php
                                  $showall="select * from product_table where label='popular'";
                ...
                <div class="container">
                    ...
                    <div class="product-container position-relative">
                        ...
                        <div class="container_fluid">
                          <div class="row">
                          <!-- <?php
                                //   $showall="select * from product_table2";
                                //   $qry=$conn->prepare($showall);
                                //   $qry->execute();
                                //   $table=$qry->get_result();
                                //   $qry->close();
                                ...
                                //  {
                                //   $i= $result['myimage_name'];
                        ?> -->
                        <?php
                                  $showall="select * from product_table where label='letest_drop'";
                                  $qry=$conn->prepare($showall);
                                  $qry->execute();
                                  $table=$qry->get_result();
                                  $qry->close();
                            ...
                            <div class="common-slider" data-slick='{
                                ...
                                <div class="instagram-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="gallery.php">
                                    ...
                                    <div class="newsletter-content newsletter-content-2 text-center">
                                        ...
                                        <div class="newsletter-form-wrapper">
                                            ...
                                            <input class="newsletter-input bg-transparent border-0" type="email"
                                                ...
                                                <button class="newsletter-btn rounded" type="submit" name="suscribe">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content newsletter-modal-content">
                    ...
                    <div class="modal-body px-4">
                        <form action="suscribe.php" method="POST" class="newletter-modal-form common-form mx-auto">
                            ...
                            <div class="newsletter-input-box d-flex align-items-center">
                                <input class="mt-2 px-3" type="email" name="eml" placeholder="Email address" required>
                                <button type="submit" class="btn-primary d-block mt-2 btn-signin" name="sbutton">SUBSCRIBE</button>
                            </div>
