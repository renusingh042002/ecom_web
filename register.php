    ...
    <div class="body-wrapper">
        ...
        <main id="MainContent" class="content-for-layout">
            <div class="login-page mt-100">
                <div class="container">
                    <form action="ragisterprocess.php" method="POST" class="login-form common-form mx-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                <button type="submit" class="btn-primary d-block mt-3 btn-signin" name="save">CREATE</button>
                            </div>
                        </div>
                    </form>
                </div>
