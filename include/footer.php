<footer class="mt-50 overflow-hidden">
                ...
                <div class="container">
                    <div class="footer-widget-wrapper">
                        <div class="row justify-content-between">
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        ...
                                        <li class="footer-menu-item"><a href="gallery.php">Our Gallery</a></li>
                                        <li class="footer-menu-item"><a href="contact.php">Contact as</a></li>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-heading d-flex align-items-center justify-content-between">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.6062640725504!2d77.2806944750686!3d28.701422475627183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfde56da97a73%3A0xaf811d3fcc5cafa3!2siics%20india!5e0!3m2!1sen!2sin!4v1682588312746!5m2!1sen!2sin" width="600" height="170 " style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div class="footer-bottom bg-4">
                <div class="container">
                    <div
                        ...
                        <!-- <p class="copyright footer-text">©<span class="current-year"></span> SACHIN SAXENA.</p> -->
                    </div>
                </div>
            </div>
        </footer>
